...
let copyDest = path.join('generator-rustm', 'generators', 'app', 'templates');
Promise.resolve().then(() => {
  return copy('boilerplate', tempDest);
}).then(() => {
...
tempDest = getPath();
console.log(tempDest);
copyDest = path.join('generator-rustmc', 'generators', 'app', 'templates');
Promise.resolve().then(() => {
